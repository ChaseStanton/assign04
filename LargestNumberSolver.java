...
public class LargestNumberSolver {
	...
	/**
	 * This method finds the largest int value that can be formed from the given array
	 * @param arr - The array to be sorted
	...
	/**
	 * This method finds the largest long value that can be formed from a given array
	 * @param arr - The array to be sorted
	...
	/**
	 * This method finds the Kth largest array based on what the biggest number formed is
	 * @param list - The list to be searched
	 * @param k - The Kth largest array to find
	 * @return an array that is the Kth largest array
	 * @throws IllegalArgumentException if the K value is too small or large to be in the list
	 */
	...
	/**
	 * This method reads a file and returns a list of arrays with each array being a line seperated by white spaces
...
/**
 * This class represents a comparator that compares the concatenations of the two numbers
 * @author Chase Stanton and Reece Kalmar
 *
 ...
 */
	...
	/**
	 * This class represents a comparator that compares two Integer Arrays based on which one has a greater
	 * value from the findLargestNumber method
	 * @author Chase Stanton and Reece Kalmar
	 *
	 */
